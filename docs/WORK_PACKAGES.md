...
| WP5 | FastAPI backend + chat web UI with citations & source viewer | [WP5-app.md](handovers/WP5-app.md) | ✅ done · 2026-07-26: **PressMeets RAG** — auth (scrypt + signed cookies, **revoked by password change / disable / delete**), SSE answers, clickable citations opening the exact passage, **History page** (search inside answers, rename, delete, reopen in chat), **admin console** (roles, password reset, account deletion + history purge) · provider text is now buffered until grounding passes |
| WP6 | Eval harness, hardening, portable export for the target system | [WP6-eval-export.md](handovers/WP6-eval-export.md) | 🚧 in progress · 2026-07-26: baseline **0.667 hit / 0.528 MRR** → production local rerank + k=12 **0.800 / 0.536** (English hit **0.727**) · fail-closed Sarvam sufficiency/generation/claim validation · **13,567 graph evidence locators resolved, 0 unresolved** · quotas/readiness/input bounds · portable export 66.8 MB · **140 offline tests** · bounded live Sarvam final: **9/9 claims supported** |
