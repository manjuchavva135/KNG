...
| WP6 | Eval harness, hardening, portable export for the target system | [WP6-eval-export.md](handovers/WP6-eval-export.md) | 🚧 in progress · 2026-07-26: baseline **0.667 hit / 0.528 MRR** → production local rerank + k=12 **0.800 / 0.536** (English hit **0.727**) · fail-closed Sarvam sufficiency/generation/claim validation · **13,567 graph evidence locators resolved, 0 unresolved** · quotas/readiness/input bounds · portable export 66.8 MB · **139 offline tests** · bounded live Sarvam final: **9/9 claims supported** |
